...
define("tests/shader/invalid.vert", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = "precision highp float;\n\nattribute vec2 wenis;\n\nvoid main() {\n  gl_Position = wenis;\n}\n";
});
define("tests/shader/pos.frag", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = "precision highp float;\n\nvarying vec3 vPos;\n\nvoid main() {\n  gl_FragColor = vec4( vPos, 1.0 );\n}";
});
define("tests/shader/quad.vert", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = "precision highp float;\n\nattribute vec2 p;\nvarying vec2 vUv;\n\nvoid main() {\n  vUv = 0.5 + 0.5 * p;\n  gl_Position = vec4( p, 0.0, 1.0 );\n}\n";
});
define("tests/shader/uv.frag", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = "precision highp float;\n\nvarying vec2 vUv;\n\nuniform float blue;\n\nvoid main() {\n  gl_FragColor = vec4( vUv, blue, 1.0 );\n}";
});
define("tests/GLCat.test", ["require", "exports", "gl", "GLCat", "tests/shader/invalid.vert", "tests/shader/pos.frag", "tests/shader/quad.vert", "tests/shader/uv.frag"], function (require, exports, gl_1, GLCat_2, invalid_vert_1, pos_frag_1, quad_vert_1, uv_frag_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    gl_1 = __importDefault(gl_1);
    invalid_vert_1 = __importDefault(invalid_vert_1);
    pos_frag_1 = __importDefault(pos_frag_1);
    quad_vert_1 = __importDefault(quad_vert_1);
    uv_frag_1 = __importDefault(uv_frag_1);
    describe('GLCat', function () {
        var gl = gl_1.default(300, 150);
        var glCat;
        it('should be instantiated', function () {
            glCat = new GLCat_2.GLCat(gl);
            expect(glCat).toBeInstanceOf(GLCat_2.GLCat);
        });
        describe('getExtension', function () {
            it('should retrieve a WebGL extension', function () {
                var ext = glCat.getExtension('ANGLE_instanced_arrays');
                expect(ext).not.toBeNull();
            });
            it('should throw an error when attempt to retrieve unsupported WebGL extension', function () {
                expect(function () {
        ...
        describe('getExtensions', function () {
            it('should deal with WebGL extensions', function () {
                var exts = glCat.getExtensions([
                    'OES_texture_float',
        ...
        describe('createShader', function () {
            it('should create a new shader object', function () {
                var shader = glCat.createShader(gl.VERTEX_SHADER, quad_vert_1.default);
                expect(shader).not.toBeNull();
            });
            it('should throw a shader compile error', function () {
                expect(function () {
                    glCat.createShader(gl.VERTEX_SHADER, invalid_vert_1.default);
                }).toThrow();
            });
        });
        describe('createProgram', function () {
            it('should create a new program object', function () {
                var program = glCat.createProgram(quad_vert_1.default, uv_frag_1.default);
                expect(program).not.toBeNull();
            });
            it('should throw a vertex shader compile error', function () {
                expect(function () {
                    glCat.createProgram(invalid_vert_1.default, uv_frag_1.default);
                }).toThrow();
            });
            it('should throw a fragment shader compile error', function () {
                expect(function () {
                    glCat.createProgram(quad_vert_1.default, quad_vert_1.default);
                }).toThrow();
            });
            it('should throw a linker compile error', function () {
                expect(function () {
                    glCat.createProgram(quad_vert_1.default, pos_frag_1.default);
                }).toThrow();
            });
        });
    });
});
define("tests/GLCatProgram.test", ["require", "exports", "gl", "GLCat", "tests/shader/quad.vert", "tests/shader/uv.frag"], function (require, exports, gl_2, GLCat_3, quad_vert_2, uv_frag_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    gl_2 = __importDefault(gl_2);
    quad_vert_2 = __importDefault(quad_vert_2);
    uv_frag_2 = __importDefault(uv_frag_2);
    describe('GLCatProgram', function () {
        var gl = gl_2.default(300, 150);
        var glCat = new GLCat_3.GLCat(gl);
        var program = glCat.createProgram(quad_vert_2.default, uv_frag_2.default);
        if (program === null) {
            throw new Error('wtf');
        }
        describe('getProgram', function () {
            it('should return its own WebGLProgram', function () {
                expect(program.getProgram()).not.toBeNull();
            });
        });
        describe('getAttribLocation', function () {
            var locationP;
            it('should return valid attribute location', function () {
                locationP = program.getAttribLocation('p');
                expect(locationP).toBeGreaterThanOrEqual(0);
            });
            it('should return same location as previous one', function () {
                var location = program.getAttribLocation('p');
                expect(location).toBe(locationP);
            });
            it('should return -1 if it receives undefined attribute name', function () {
                var location = program.getAttribLocation('normal');
                expect(location).toBe(-1);
            });
        });
        describe('getUniformLocation', function () {
            var locationBlue;
            it('should return valid uniform location', function () {
                locationBlue = program.getUniformLocation('blue');
                expect(locationBlue).not.toBeNull();
            });
            it('should return same location as previous one', function () {
                var location = program.getUniformLocation('blue');
                expect(location).toBe(locationBlue);
            });
            it('should return null if it receives undefined uniform name', function () {
                var location = program.getUniformLocation('time');
