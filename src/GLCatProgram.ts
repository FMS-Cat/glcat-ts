...
export class GLCatProgram {
   ...
   */
  public uniformTexture( name: string, texture: WebGLTexture, number: number = 0 ): void {
    const gl = this.glCat.getRenderingContext();
   ...
   * @param number Specify a texture unit, in integer
   */
  public uniformCubemap( name: string, texture: WebGLTexture, number: number = 0 ): void {
    const gl = this.glCat.getRenderingContext();
